  ...
  const tableData = useMemo(
    () =>
      data.map((row: any) => {
        ...
        const formatDigit = (v: number) => toDigit({ locale, num: v })
        const formatPercentage = (v: number) =>
          toPercentage({ locale, num: v })
        ...
        return {
          ...
          porcentajePoblacionAdministradas: formatPercentage(
            porcentajePoblacionAdministradas
          ),
          porcentajePoblacionCompletas: formatPercentage(
            porcentajePoblacionCompletas
          )
        }
      }),
